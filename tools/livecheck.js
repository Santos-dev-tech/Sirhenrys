/* Live check against sir-henrys.web.app. (was: App Check must be harmless when not configured, and must not break the app it is
...
(async()=>{
 ...
 await p.goto('https://sir-henrys.web.app/',{waitUntil:'domcontentloaded',timeout:60000});
